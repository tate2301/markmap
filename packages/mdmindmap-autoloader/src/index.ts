import {
  ...
  loadJS,
  urlBuilder,
} from 'mdmindmap-common';
import type { Transformer } from 'mdmindmap-lib';
...
const autoLoaderOptions = {
  baseJs: [
    ...
    `mdmindmap-lib@${__define__.LIB_VERSION}`,
    `mdmindmap-view@${__define__.VIEW_VERSION}`,
    `mdmindmap-toolbar@${__define__.TOOLBAR_VERSION}`,
  ],
  baseCss: [`mdmindmap-toolbar@${__define__.TOOLBAR_VERSION}/dist/style.css`],
  manual: false,
  toolbar: false,
