...
import { buildCSSItem, buildJSItem, JSItem } from 'mdmindmap-common';
import { IAssets } from 'mdmindmap-lib';
import { dirname } from 'path';
import { fileURLToPath } from 'url';

const TOOLBAR_VERSION = __define__.TOOLBAR_VERSION;
const TOOLBAR_CSS = `mdmindmap-toolbar@${TOOLBAR_VERSION}/dist/style.css`;
const TOOLBAR_JS = `mdmindmap-toolbar@${TOOLBAR_VERSION}/dist/index.js`;
